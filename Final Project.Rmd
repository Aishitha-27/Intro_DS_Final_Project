...
```
We look into distribution of data points bcz we want to understand the frequency of of data points across intervals and compare the observed distribution of data to a theoretical distribution(why?)
