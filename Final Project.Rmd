...
ggplot(comparison, aes(x = Actual, y = Predicted)) +
  ...
  labs(
    title = "Predicted vs Actual Quantities Sold",
    x = "Actual Quantity Sold",
    y = "Predicted Quantity Sold"
  ) +
  theme_minimal()
```
...
confusion_matrix <- table(
  Actual = test_data$SalesChannelBinary,
  Predicted = test_data$PredictedClass
)
...
plot(roc_curve, main = "ROC Curve for Sales Channel Classification")
auc <- auc(roc_curve)
...
plot(roc_curve, main = "ROC Curve for Product Returns Classification")
auc <- auc(roc_curve)
cat("Area Under the Curve (AUC):", auc, "\n")
