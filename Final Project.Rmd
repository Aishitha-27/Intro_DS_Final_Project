...
plot(fpr, tpr, type = "l", col = "blue", lwd = 2,
     ...
     main = "Manual ROC Curve for Logistic Regression")

# Calculate AUC using the trapezoidal rule
auc_manual <- sum(diff(fpr) * (tpr[-1] + tpr[-length(tpr)]) / 2)

# Output the AUC value
print(paste("Manual AUC:", auc_manual))
